...
class HSIFCResNetModel(HSIFCModel):
    """
    Extends HSIFCModel with a ResNet backbone for feature extraction from hyperspectral image patches.
    """

    def __init__(self, input_channels, patch_size, n_classes, dropout=False, base_model='resnet50'):
        """
        ...
        Args:
            ...
            n_classes (int): Number of output classes.
            dropout (bool, optional): If True, applies dropout with p=0.5. Defaults to False.
            base_model (str, optional): Specifies the ResNet variant to use. Defaults to 'resnet50'.
        """
        ...
        # Adjust the first convolutional layer of the ResNet model to accept hyperspectral input
        ...
        # Modify the first fully connected layer of HSIFCModel to accept features extracted by ResNet
